...
public abstract class ConditionalFileFilterAbstractTestCase extends IOFileFilterAbstractTestCase {
    ...
    public void setUpTestFilters(FileFilter fileFilter) {
        // filters
        //tests
        ...
        // test 1 - Test conditional with all filters returning true
        {
          // test 1 filters
          ...
          // test 1 true results
          final boolean[] trueResults = fileFilter.equals(FileFilter.ANDFILEFILTER)? new boolean[] {true, true, true} : new boolean[] {true, false, false} ;
        ...
        // test 2 - Test conditional  with first filter returning false
        {
          // test 2 filters
          final List<IOFileFilter> filters = new ArrayList<IOFileFilter>();
          ...
          // test 2 true results
          final boolean[] trueResults = fileFilter.equals(FileFilter.ANDFILEFILTER)? new boolean[] {false, false, false} : new boolean[] {true, false, false};
          ...
          testFileResults.add(2, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
          testFilenameResults.add(2, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
        }

        // test 3 - Test conditional with second filter returning false
        {
          // test 3 filters
          final List<IOFileFilter> filters = new ArrayList<IOFileFilter>();
          filters.add(trueFilters[1]);
          ...
          final boolean[] falseResults = fileFilter.equals(FileFilter.ANDFILEFILTER)? new boolean[] {true, false, false} : new boolean[] {false, false, false};
          testFilters.add(3, filters);
          testTrueResults.add(3, trueResults);
          testFalseResults.add(3, falseResults);
          testFileResults.add(3, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
          testFilenameResults.add(3, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
        }
        ...
        // test 4 - Test conditional and with third filter returning false
        {
          ...
          filters.add(falseFilters[3]);
          // test 4 true results
          final boolean[] trueResults = fileFilter.equals(FileFilter.ANDFILEFILTER)? new boolean[] {true, true, false} : new boolean[] {true, false, false};
          ...
          testFileResults.add(4, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
          testFilenameResults.add(4, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
        }
        ...
        // test 5 - Test conditional and with first and third filters returning false
        {
          ...
          testFileResults.add(5, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
          testFilenameResults.add(5, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
        }
        ...
        // test 6 - Test conditional and with second and third filters returning false
        {
          ...
          testFileResults.add(6, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
          testFilenameResults.add(6, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
        }
        ...
        // test 7 - Test conditional and with first and second filters returning false
        {
          ...
          final boolean[] falseResults = fileFilter.equals(FileFilter.ANDFILEFILTER)? new boolean[] {true, false, false} : new boolean[] {true, true, false};

          testFilters.add(7, filters);
          testTrueResults.add(7, trueResults);
          testFalseResults.add(7, falseResults);
          testFileResults.add(7, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
          testFilenameResults.add(7,fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
        }
        ...
        // test 8 - Test conditional and with fourth filters returning false
        {
          ...
          testFileResults.add(8, fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
          testFilenameResults.add(8,fileFilter.equals(FileFilter.ANDFILEFILTER)? Boolean.FALSE : Boolean.TRUE);
        }
        ...
        // test 9 - Test conditional and with all filters returning false
        {
          ...
          final boolean[] falseResults = fileFilter.equals(FileFilter.ANDFILEFILTER)? new boolean[] {true, false, false} : new boolean[] {true, true, true};
